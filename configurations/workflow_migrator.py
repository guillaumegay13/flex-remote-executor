...
class WorfklowMigrator:
    ...
    def get_workflow_definition_dependancies(self):
        ...
        for action in actionList:
            full_dependancy_list.extend(self.get_action_dependancies(self.flex_cm_client, action))
        ...
        full_dependancy_list.append(self.workflow_definition)

        # Clean up the duplicates
        unique_dependancy_list = []
        for dependancy in full_dependancy_list:
            if dependancy not in unique_dependancy_list:
                self.dependancy_list.append(dependancy)

    def get_action_dependancies(self, action):
        """Recursively get action dependancies."""
        action_dependancy_list = []
        ...
        match action.objectTypeName:
            case "transcode":
                ...
                action_dependancy_list.append(transcode_resource)
                # Transcode profile
                ...
                for output_file in output_file_list:
                    ...
                    action_dependancy_list.append(transcode_profile)
                # Output resource
                ...
                for dependancy in self.get_action_dependancies(self.flex_cm_client, output_resource):
                    action_dependancy_list.append(dependancy)
                action_dependancy_list.append(output_resource)
            case "launch":
                action_configuration = self.flex_cm_client.get_object_configuration(action.id, "action")
                # Workflow definition
                ...
                for dependancy in self.get_action_dependancies(self.flex_cm_client, workflow_definition):
                    action_dependancy_list.append(dependancy)
                action_dependancy_list.append(workflow_definition)
            case "import":
                action_configuration = self.flex_cm_client.get_object_configuration(action.id, "action")
                # Workflow definition
                ...
                if not source_resource_instance["isExpression"]:
                    ...
                    for dependancy in self.get_action_dependancies(self.flex_cm_client, source_resource):
                        action_dependancy_list.append(dependancy)
                    action_dependancy_list.append(source_resource)
                if action_configuration["instance"]["source-file"]["move-file"]["move-target-resource"]:
                    ...
                    for dependancy in self.get_action_dependancies(self.flex_cm_client, move_resource):
                        action_dependancy_list.append(dependancy)
                    action_dependancy_list.append(move_resource)
            case "script":
                pass
            case "decision":
                pass
                ...
                match resourceSubType:
                    ...
                    case "Folder":
                        ...
                        for storage_resource_instance in storage_resource_instances:                
                            ...
                            action_dependancy_list.append(storage_resource)
                    case "Transcode":
            ...
            case "workflow-definition":
                action_dependancy_list.extend(self.get_workflow_definition_dependancies(self.flex_cm_client, action))
            case _:
